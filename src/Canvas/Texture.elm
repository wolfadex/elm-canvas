...
sprite data texture =
    case texture of
        Canvas.Internal.Texture.TImage image ->
            Canvas.Internal.Texture.TSprite data image

        Canvas.Internal.Texture.TSprite _ image ->
            Canvas.Internal.Texture.TSprite data image
...
dimensions texture =
    case texture of
        ...
        Canvas.Internal.Texture.TSprite data _ ->
...
-}
fromDomImage : Value -> Maybe Texture
fromDomImage value =
    Json.Decode.decodeValue Canvas.Internal.Texture.decodeTextureImage value
        |> Result.toMaybe
