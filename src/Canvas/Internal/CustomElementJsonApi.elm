...
font : String -> Command
font f =
    field "font" (Json.Encode.string f)
...
globalAlpha alpha =
    field "globalAlpha" (Json.Encode.float alpha)
...
globalCompositeOperation mode =
    field "globalCompositeOperation" (Json.Encode.string mode)
...
globalImageSmoothingEnabled enabled =
    field "imageSmoothingEnabled" (Json.Encode.bool enabled)
...
lineDashOffset value =
    field "lineDashOffset" (Json.Encode.float value)
...
lineJoin join =
    field "lineJoin" (Json.Encode.string join)
...
lineWidth value =
    field "lineWidth" (Json.Encode.float value)
...
miterLimit value =
    field "miterLimit" (Json.Encode.float value)
...
shadowBlur value =
    field "shadowBlur" (Json.Encode.float value)
...
shadowOffsetX value =
    field "shadowOffsetX" (Json.Encode.float value)
...
shadowOffsetY value =
    field "shadowOffsetY" (Json.Encode.float value)
...
textAlign align =
    field "textAlign" (Json.Encode.string align)
...
textBaseline baseline =
    field "textBaseline" (Json.Encode.string baseline)
...
arc x y radius startAngle endAngle anticlockwise =
    fn "arc"
        [ Json.Encode.float x
        , Json.Encode.float y
        , Json.Encode.float radius
        , Json.Encode.float startAngle
        , Json.Encode.float endAngle
        , Json.Encode.bool anticlockwise
        ]
...
arcTo x1 y1 x2 y2 radius =
    fn "arcTo"
        [ Json.Encode.float x1
        , Json.Encode.float y1
        , Json.Encode.float x2
        , Json.Encode.float y2
        , Json.Encode.float radius
        ]
...
bezierCurveTo cp1x cp1y cp2x cp2y x y =
    fn "bezierCurveTo"
        [ Json.Encode.float cp1x
        , Json.Encode.float cp1y
        , Json.Encode.float cp2x
        , Json.Encode.float cp2y
        , Json.Encode.float x
        , Json.Encode.float y
        ]
...
clip fillRule =
    fn "clip" [ Json.Encode.string (fillRuleToString fillRule) ]
...
fill fillRule =
    fn "fill" [ Json.Encode.string (fillRuleToString fillRule) ]
...
-}
circle : Circle2d Meters WorldCoordinates -> Command
circle c =
    let
        ( x, y ) =
...
fillText text x y maybeMaxWidth =
    case maybeMaxWidth of
        Nothing ->
            fn "fillText" [ Json.Encode.string text, Json.Encode.float x, Json.Encode.float y ]
...
lineTo x y =
    fn "lineTo" [ Json.Encode.float x, Json.Encode.float y ]
...
moveTo x y =
    fn "moveTo" [ Json.Encode.float x, Json.Encode.float y ]
...
quadraticCurveTo cpx cpy x y =
    fn "quadraticCurveTo"
        [ Json.Encode.float cpx
        , Json.Encode.float cpy
        , Json.Encode.float x
        , Json.Encode.float y
        ]
...
rotate angle =
    fn "rotate" [ Json.Encode.float angle ]
...
scale x y =
    fn "scale" [ Json.Encode.float x, Json.Encode.float y ]
...
setLineDash segments =
    fn "setLineDash" [ Json.Encode.list Json.Encode.float segments ]
...
strokeText text x y maybeMaxWidth =
    case maybeMaxWidth of
        Nothing ->
            fn "strokeText" [ Json.Encode.string text, Json.Encode.float x, Json.Encode.float y ]
...
translate x y =
    fn "translate" [ Json.Encode.float x, Json.Encode.float y ]


drawImage : Float -> Float -> Float -> Float -> Float -> Float -> Float -> Float -> Value -> Command
drawImage sx sy sw sh dx dy dw dh imageObj =
    fn "drawImage"
        [ imageObj
        , Json.Encode.float sx
        , Json.Encode.float sy
        , Json.Encode.float sw
        , Json.Encode.float sh
        , Json.Encode.float dx
        , Json.Encode.float dy
        , Json.Encode.float dw
        , Json.Encode.float dh
        ]
...
fn name args =
    Json.Encode.object
        ...
        , ( "name", Json.Encode.string name )
        , ( "args", Json.Encode.list identity args )
        ]
