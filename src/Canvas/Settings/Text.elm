...
import Canvas.Internal.Canvas exposing (Drawable(..), Setting(..))
...
font { size, family } =
    (String.fromInt size ++ "px " ++ family)
        |> Canvas.Internal.CustomElementJsonApi.font
        |> SettingCommand
...
align alignment =
    SettingCommand <| Canvas.Internal.CustomElementJsonApi.textAlign <| textAlignToString alignment
...
baseLine textBaseLine =
    SettingCommand <| Canvas.Internal.CustomElementJsonApi.textBaseline <| textBaseLineToString textBaseLine
