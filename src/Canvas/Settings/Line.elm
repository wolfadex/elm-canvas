...
lineCap cap =
    cap |> lineCapToString |> Canvas.Internal.CustomElementJsonApi.lineCap |> SettingCommand
...
lineDashOffset offset =
    Canvas.Internal.CustomElementJsonApi.lineDashOffset offset
        |> SettingCommand
...
lineJoin join =
    join |> lineJoinToString |> Canvas.Internal.CustomElementJsonApi.lineJoin |> SettingCommand
...
lineWidth width =
    Canvas.Internal.CustomElementJsonApi.lineWidth width |> SettingCommand
...
miterLimit limit =
    Canvas.Internal.CustomElementJsonApi.miterLimit limit |> SettingCommand
...
lineDash dashSettings =
    Canvas.Internal.CustomElementJsonApi.setLineDash dashSettings |> SettingCommand
