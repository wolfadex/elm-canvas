...
import Canvas.Internal.Canvas exposing (Setting(..))
import Canvas.Internal.CustomElementJsonApi
...
shadow { blur, color, offset } =
    ...
    in
    SettingCommands
        [ Canvas.Internal.CustomElementJsonApi.shadowBlur blur
        , Canvas.Internal.CustomElementJsonApi.shadowColor color
        , Canvas.Internal.CustomElementJsonApi.shadowOffsetX x
        , Canvas.Internal.CustomElementJsonApi.shadowOffsetY y
        ]
...
alpha : Float -> Setting
alpha a =
    Canvas.Internal.CustomElementJsonApi.globalAlpha a |> SettingCommand
...
compositeOperationMode mode =
    mode |> globalCompositeOperationModeToString |> Canvas.Internal.CustomElementJsonApi.globalCompositeOperation |> SettingCommand
...
imageSmoothing enabled =
    SettingCommand (Canvas.Internal.CustomElementJsonApi.globalImageSmoothingEnabled enabled)
    ...
    SettingCommands <|
        List.map
            (\t ->
                case t of
                    Rotate angle ->
                        Canvas.Internal.CustomElementJsonApi.rotate angle

                    Scale x y ->
                        Canvas.Internal.CustomElementJsonApi.scale x y

                    Translate x y ->
                        Canvas.Internal.CustomElementJsonApi.translate x y

                    ApplyMatrix { m11, m12, m21, m22, dx, dy } ->
                        Canvas.Internal.CustomElementJsonApi.transform m11 m12 m21 m22 dx dy
            )
            transforms
